...
#   5. Configures the target for SIA connections
#
# Usage: ./02_configure_target.sh [--force]
...
LOG_FILE="${LOG_DIR}/configure_target.log"
FLAG="${LOG_DIR}/sia_configure_done"
...
log "==========================================="
log "Starting SIA Target Configuration"
log "==========================================="
